...
<script>
$(function () {
	$('#picture').before('<div id = "nav" class = "nav">').cycle({
		fx: 'turnDown',
        timeout: 3000,
	});
});
...
<div id="picture"> <img src = "images/kobe.jpg" width="100%" height="100%" /> <img src = "images/bgwade.jpg" width="100%" height="100%" /> <img src = "images/stephen.jpg" width="100%" height="100%" /> <img src = "images/bgjames.jpg" width="100%" height="100%" /> <img src = "images/bgkyrie.jpg" width="100%" height="100%" /></div>
  <div id="rightsidebar">
...
<div id="sch">
	...
	<div id="content">
  <div id="content_title" align="center"><span class="style3" style='color:white'><strong>所 &emsp;有 &emsp;商 &emsp;品</strong></span></div>
  <div id="content_picture">
  <p>
  <?php
  $total_records=mysqli_num_rows($content_result);
  $total_page = ceil($total_records / 8);
  mysqli_data_seek($content_result,($_GET['page']-1)*8);
  for($j = 0; $j < 8; $j++)
  {
  	$content_row = mysqli_fetch_assoc($content_result);
    $checkfinaltype = $content_row["type"];
    if($checkfinaltype == 10)
      $j = 7;
  	$pic_name = $content_row["pic_name"];
  	echo "<a href=\"merchandise.php?search=+\"><img src=\"images/$pic_name\" width=\"178\" height=\"138\"; ></a>"; echo"&nbsp;&nbsp;";
  	$merch_name = $content_row["merch_name"];
  	$money = $content_row["money"];
  	echo "<a href=\"merchandise.php?search=+\">$merch_name&nbsp;$$money</a>"; echo"&nbsp;&nbsp;";
    if($j == 3)
      echo "</br></br></br>";
    if($checkfinaltype == 10)
      echo "</br></br></br></br></br></br></br></br></br></br></br>";
  }
  mysqli_free_result($content_result); // 釋放佔用的記憶體
  ...
  if($total_records != 0){
    ...
    $next_page=$page+1;
    if($page > 1)
      echo "<li><a href='index.php?page=$pre_page'><</a>&nbsp;&nbsp;</li>";
    for($j = 1; $j <= $total_page; $j++){
      if($j == $_GET['page']) echo "<li><a>$j</a></li>";
      else echo "<li><a href = 'index.php?page=$j'> $j </a>&nbsp;&nbsp;</li>";
    }
